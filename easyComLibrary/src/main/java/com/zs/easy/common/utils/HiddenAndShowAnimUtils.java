 ...
 * Date:2017/3/30.
 */
public class HiddenAndShowAnimUtils {
     ...
     */
    public static HiddenAndShowAnimUtils newInstance(Context context, View hideView, View down, int height) {
        return new HiddenAndShowAnimUtils(context, hideView, down, height);
    }

    private HiddenAndShowAnimUtils(Context context, View hideView, View down, int height) {
        this.hideView = hideView;
        this.down = down;
        float mDensity = EasyVariable.mContext.getResources().getDisplayMetrics().density;
        LogUtil.i("desity = " + mDensity);
